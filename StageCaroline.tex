...
\end{equation}
où la deuxième égalité est une integration par parties où on a supprimé le terme aux bords (les variations $\delta x$ sont toujours nuls aux bords). 
Donc
\begin{flalign*}
&\frac{\delta H}{\delta \pt^j(\sigma')} = 2\pi\int_0^\pi\pt^i(\sigma)\frac{\delta P_{\tau i}(\sigma)}{\delta \pt^j(\sigma')}d\sigma = 2\pi\int_0^\pi\pt^i(\sigma)\delta_i^j\delta(\sigma-\sigma')d\sigma=2\pi \pt^j(\sigma')=\dot{x}^j \\
&\frac{\delta H}{\delta x^j(\sigma')} = -\int_0^\pi\frac{x^{''i}(\sigma)}{2\pi}\frac{\delta x_i(\sigma)}{\delta x^j(\sigma')}d\sigma=-\int_0^\pi\frac{x^{''i}(\sigma)}{2\pi}\delta_i^j\delta(\sigma-\sigma')d\sigma=-\frac{x^{''j}(\sigma')}{2\pi}=-\dot{\pt}^j
\end{flalign*}
