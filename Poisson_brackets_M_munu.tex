...
\begin{flalign*}
&\{\Mup{i+},\Mup{j-}\}=\Big\{\frac{1}{\sqrt{2}}q_0^ia_0^+,\frac{1}{\sqrt{2}}\left( q_0^j a_0^- -q_0^- a_0^j\right) +i\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_n^j a_{-n}^-}{n}\Big\} \\
&=\frac{a_0^+}{2}\Big\{q_0^i,a_0^-\Big\}q_0^j - \frac{q_0^i a_0^j}{2}\{a_0^+,q_0^-\} -\frac{a_0^+ q_0^-}{2}\{q_0^i,a_0^j\}+\frac{i a_0^+}{\sqrt{2}}\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{1}{n} \{q_0^i,a_{-n}^-\}a_n^j\\
&=\frac{a_0^+}{2}\frac{\sqrt{2}a_0^i}{a_0^+}q_0^j- \frac{q_0^i a_0^j}{2}\sqrt{2} -\frac{a_0^+ q_0^-}{2}\sqrt{2}\delta^{ij} +\frac{i a_0^+}{\sqrt{2}}\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{1}{n} \frac{\sqrt{2}a_{-n}^i}{a_0^+}a_n^j\\
&=\delta^{ij}\frac{-q_0^- a_0^+}{\sqrt{2}}+\frac{q_0^j a_0^i -q_0^i a_0^j}{\sqrt{2}} +i\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_{-n}^ia_n^j}{n} =\delta^{ij}\Mup{+-}-\Mup{ij} \square
\end{flalign*}
\textbf{Démonstration de \eqref{eq3}:}
\begin{flalign*}
&\{\Mup{i-},\Mup{j-}\}=\Big\{\frac{1}{\sqrt{2}}\left( q_0^i a_0^- -q_0^- a_0^i\right) +i\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_n^i a_{-n}^-}{n},\frac{1}{\sqrt{2}}\left( q_0^j a_0^- -q_0^- a_0^j\right) +i\sum_{m=-\infty; m\neq 0}^{+\infty}\frac{a_m^j a_{-m}^-}{m}\Big\}\\
&=\frac{1}{2}\Big\{q_0^ia_0^- - q_0^-a_0^i,q_0^ja_0^- - q_0^-a_0^j\Big\}+\frac{i}{\sqrt{2}}\Big\{q_0^ia_0^- - q_0^-a_0^i,\sum_{m=-\infty; m\neq 0}^{+\infty}\frac{a_m^j a_{-m}^-}{m}\Big\}\\
& + \frac{i}{\sqrt{2}}\Big\{\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_n^i a_{-n}^-}{n},q_0^ja_0^- - q_0^-a_0^i\Big\} - \left\{\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_n^i a_{-n}^-}{n},\sum_{m=-\infty; m\neq 0}^{+\infty}\frac{a_m^j a_{-m}^-}{m}\right\}\\
\end{flalign*}
\textbf{Premier terme:}\\
...
\begin{flalign*}
&\frac{i}{\sqrt{2}}\left( \Big\{q_0^ia_0^- - q_0^-a_0^i,\sum_{m=-\infty; m\neq 0}^{+\infty}\frac{a_m^j a_{-m}^-}{m}\Big\}+ \Big\{\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_n^i a_{-n}^-}{n},q_0^ja_0^- - q_0^-a_0^i\Big\}\right) \\
&=\frac{i}{\sqrt{2}}\left\{q_0^ia_0^-,\sum_{m=-\infty; m\neq 0}^{+\infty}\frac{a_m^j a_{-m}^-}{m}\right\} - \frac{i}{\sqrt{2}}\left\{q_0^-a_0^i,\sum_{m=-\infty; m\neq 0}^{+\infty}\frac{a_m^j a_{-m}^-}{m}\right\}+ \frac{i}{\sqrt{2}}\left\{\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_n^i a_{-n}^-}{n},q_0^ja_0^-\right\}\\
& - \frac{i}{\sqrt{2}}\left\{\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_n^i a_{-n}^-}{n},q_0^-a_0^j\right\}=(**)
\end{flalign*}
...
\begin{flalign*}
(**)&=\frac{i}{\sqrt{2}}\left(\sum_{m=-\infty; m\neq 0}^{+\infty}\frac{q_0^ia_{-m}^-}{m}im\frac{a_m^j}{a_0^+}+\sum_{m=-\infty; m\neq 0}^{+\infty}\frac{q_0^ia_{m}^j}{m}(-im\frac{a_{-m}^-}{a_0^+}) + \sum_{m=-\infty; m\neq 0}^{+\infty}\frac{a_0^-a_{m}^j}{m}\sqrt{2}\frac{a_{-m}^i}{a_0^+}\right)\\ 
&+\frac{i}{\sqrt{2}}\left(\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{q_0^ja_{-n}^-}{n}in\frac{a_n^i}{a_0^+}+\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{q_0^ja_{n}^i}{n}(-in\frac{a_{-n}^-}{a_0^+}) +\sum_{n=-\infty; n\neq 0}^{+\infty}\frac{a_0^-a_n^i}{n}\sqrt{2}\frac{a_{-m}^j}{a_0^+}\right)\\
&=0
\end{flalign*}
